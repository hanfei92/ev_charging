...
OutputData CHAdeMO::run(ChargingState const &state, charging_robot_system_msgs::msg::InverterState const &inv_msg) {
    output_data_.can1_msgs.header.stamp = this->clock_->now(); ///todo
    ...
    output_data_.can2_msgs.header.stamp = this->clock_->now(); ///todo
    ...
    output_data_.can2_msgs.id = 0x00000208;

    switch (state) {
        case ChargingState::IDLE:
            output_data_.can1_msgs.data.at(0) = 0x00; // 1st 8 bits 00000000
            output_data_.can1_msgs.data.at(1) = 0x00; // 2nd 8 bits 0x1E      Channel A Max current
            output_data_.can1_msgs.data.at(2) = 0x00; // 3rd 8 bits 00000000
            output_data_.can1_msgs.data.at(3) = 0x00; // 4th 8 bits 0x1E      Channel B Max current
            ...
            output_data_.can2_msgs.data.at(1) = 0x00; // 2nd 8 bits 0x1E      
            output_data_.can2_msgs.data.at(2) = 0x00; // 3rd 8 bits 00000000  measured current
            output_data_.can2_msgs.data.at(3) = 0x00; // 4th 8 bits 0x1E      Channel B Max current
        ...
        case ChargingState::WAKE:
            output_data_.can1_msgs.data.at(0) = 0x01; // 1st 8 bits 00000000
            output_data_.can1_msgs.data.at(1) = 0x0C; // 2nd 8 bits 0x1E      Channel A Max current
            output_data_.can1_msgs.data.at(2) = 0x00; // 3rd 8 bits 00000000
            output_data_.can1_msgs.data.at(3) = 0x00; // 4th 8 bits 0x1E      Channel B Max current
            output_data_.can1_msgs.data.at(4) = 0x00; // 5th 8 bits 00000000  CAN Data format version
            output_data_.can1_msgs.data.at(5) = 0x00; // 6th 8 bits 00000001  01(CHAdeMO ON) 02(Combo_ON)
        ...
        case ChargingState::START:
            output_data_.can1_msgs.data.at(0) = 0x02; // 1st 8 bits 00000000
            output_data_.can1_msgs.data.at(1) = 0x0C; // 2nd 8 bits 0x1E      Channel A Max current
            output_data_.can1_msgs.data.at(2) = 0x00; // 3rd 8 bits 00000000
            output_data_.can1_msgs.data.at(3) = 0x00; // 4th 8 bits 0x1E      Channel B Max current
            output_data_.can1_msgs.data.at(4) = 0x00; // 5th 8 bits 00000000  CAN Data format version
        ...
        case ChargingState::CHARGING:
            ...
            if (inv_msg.outputcurrent < 9) {
                output_data_.can1_msgs.data.at(1) = 0x0C;
            } else {
                output_data_.can1_msgs.data.at(1) = 0x14;
            }
            // 2nd 8 bits 0x1E      Channel A Max current
            output_data_.can1_msgs.data.at(2) = 0x00; // 3rd 8 bits 00000000
            output_data_.can1_msgs.data.at(3) = 0x00; // 4th 8 bits 0x1E      Channel B Max current
            output_data_.can1_msgs.data.at(4) = 0x00; // 5th 8 bits 00000000  CAN Data format version
            output_data_.can1_msgs.data.at(5) = 0x00; // 6th 8 bits 00000001  01(CHAdeMO ON) 02(Combo_ON)
        ...
        case ChargingState::STOP:
            output_data_.can1_msgs.data.at(0) = 0x03; // 1st 8 bits 00000000
            output_data_.can1_msgs.data.at(1) = 0x00; // 2nd 8 bits 0x1E      Channel A Max current
            output_data_.can1_msgs.data.at(2) = 0x00; // 3rd 8 bits 00000000
            output_data_.can1_msgs.data.at(3) = 0x00; // 4th 8 bits 0x1E      Channel B Max current
            output_data_.can1_msgs.data.at(4) = 0x00; // 5th 8 bits 00000000  CAN Data format version
